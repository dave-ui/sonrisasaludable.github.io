<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <br>
            <form class="needs-validation form-horizontal" method="post" id="addproduct" enctype="multipart/form-data" action="index.php?view=addpacient" role="form" novalidate>
