<section class="content">
  ...
  <option value="">-- SELECCIONE --</option>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-4">
                <textarea class="form-control" name="sick" placeholder="Enfermedad" required></textarea>
              </div>
            </div>
            <div class="form-group">
            ...
            <!-- <div class="form-group">
              ...
              <div class="col-lg-10">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="price" placeholder="Costo" required>
                </div>
              </div>
            </div> -->
            <div class="form-group">
