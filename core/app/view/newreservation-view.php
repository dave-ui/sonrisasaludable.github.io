<section class="content">
      ...
      <div class="row">
        <div class="col-md-10">
          ...
          <form class="form-horizontal needs-validation" role="form" method="post" action="./?action=addreservation" id="newreservation" novalidate>
            <div class="form-group">
              <div class="col-lg-3 col-lg-offset-2">
                <label for="inputEmail1" class="control-label">Codigo de cita</label>
                <input type="text" name="no" class="form-control" id="inputEmail1" placeholder="Cod." required>
              </div>
              <div class="col-lg-7">
                <label for="inputEmail1" class="control-label">nueva cita?</label>
  ...
  <option value="">-- SELECCIONE --</option>
            ...
            <div class="form-group">
              <label for="inputEmail1" class="col-lg-2 control-label">observaciones</label>
              <div class="col-lg-4">
                <textarea class="form-control" name="note" placeholder="Nota" required></textarea>
              </div>
              <label for="inputEmail1" class="col-lg-2 control-label">motivo de la cita</label>
              <div class="col-lg-4">
                <textarea class="form-control" name="detall" placeholder="Enfermedad" required></textarea>
              </div>
            </div>
            <!-- <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="hidden" name="quirur" value="3">
