...
-->
            ...
            <h1>procedimientos no quirurgicos</h1>
            <a href="./index.php?view=newquirurgico2" class="btn btn-default"><i class='fa fa-asterisk'></i> Nuevo procedimiento</a>
            ...
            if ((isset($_GET["q"]) && isset($_GET["pacient_id"]) && isset($_GET["medic_id"]) && isset($_GET["date_at"])) && ($_GET["q"] != "" || $_GET["pacient_id"] != "" || $_GET["medic_id"] != "" || $_GET["date_at"] != "")) {
                ...
                if ($_GET["q"] != "") {
                    $sql .= " title like '%$_GET[q]%' or note like '%$_GET[q] %' and quirur=0";
                }
