<?php
$msgs = MsgData::getAllByPM($_GET["pacient_id"], $_SESSION["medic_id"]);
...
<div class="btn-group pull-right">
		...
		<h1>Mis Mensajes con el paciente <?php echo $pacient->name." ".$pacient->lastname; ?></h1>
<br>
...
$medic = MedicData::getById($msg->medic_id);
 	...
 	<?php echo $msg->content; ?>
                ...
                <div class="box-footer">
                  <form action="./?action=send2" enctype="multipart/form-data" method="post">
