...
<div class="input-group">
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="id" value="<?php echo $reservation->id; ?>">
      ...
      <!-- <a href="index.php?action=delreservation&id=<?php echo $user->id; ?>" class="btn btn-danger" formaction="">Eliminar</a> -->

      <a href="index.php?action=delreservation&id=<?php echo $reservation->id; ?>" class="btn btn-danger">Eliminar</a>
